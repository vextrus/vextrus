...
| `docs/specs/harness.md` | how the takeoff module is planned and built — the pipeline, the ticket contract, model and effort per class, the metrics; **accepted 2026-08-16** | before charting a map, writing a build ticket, or proposing anything that would run Claude |
